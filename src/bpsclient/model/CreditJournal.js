...
export default class CreditJournal {
   ...
   * @param billNr {String} which bill is assosiated with the payment or topup
   */
  constructor(timestamp, cardId, amount, billNr) {
...
/**
 * which bill is assosiated with the payment or topup
